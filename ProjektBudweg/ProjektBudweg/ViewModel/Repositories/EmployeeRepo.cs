        ...
        public int Add (Employee employee)
        {
            ...
            try
            {
                using (SqlConnection _sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand _sqlCommand = new SqlCommand("INSERT INTO TABLE Bud_Employee (Employee_ID, Department)" 
                                                                 + "VALUES(@EmployeeID, @Department)", _sqlConnection))
                    {
                        // Add the EmployeeID and Department parameters to the command object.
                        _sqlCommand.Parameters.Add("@EmployeeID", SqlDbType.NVarChar).Value = employee.EmployeeID;
